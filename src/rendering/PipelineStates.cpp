...
ComPtr<ID3D12RootSignature> PipelineStates::m_RootSignature = nullptr;
std::unordered_map<std::string, ComPtr<ID3D12PipelineState>> PipelineStates::m_PSOs;

void PipelineStates::Init(ComPtr<ID3D12Device> device)
{
...
void PipelineStates::BuildRootSignature(ComPtr<ID3D12Device> device)
{ 
